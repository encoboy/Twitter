export default {
  ...
  'pages.searchTable.fenxizongliang': 'Total penggemar',
  'pages.searchTable.fenxigaibian': 'Penggemar berubah',
  'pages.searchTable.zhangfenlv': 'Tingkat membengkak tepi',
  'pages.searchTable.dianzanliang': 'Total suka',
  'pages.searchTable.pinglunliang': 'Total komentar',
  'pages.searchTable.zhuanfaliang': 'Total Pengiriman',
  'pages.searchTable.list': 'daftar',
  'pages.searchTable.ri': 'hari',
  'pages.searchTable.yue': 'bulan',
  'pages.searchTable.nian': 'tahun',
  'pages.searchTable.name': 'nama',
  'pages.searchTable.zanfenbi': 'Nisbah bubuk Zambia',
  'pages.searchTable.fensinum': 'Jumlah penggemar',
  'pages.searchTable.dianzannum': 'Jumlah yang suka',
  'pages.searchTable.pinglunnum': 'Jumlah komentar',
  'pages.searchTable.zhuanfanum': 'Mengirim jumlah',
  'pages.searchTable.tuiwennum': 'Jumlah tweet',
  'pages.searchTable.del': 'hapus',
  'pages.searchTable.add': 'tambah ke',
  'pages.searchTable.shujutonji': 'statistik data',
  'pages.searchTable.zhanghaotongji': 'Statistik rekening sendiri',
  'pages.searchTable.sanfangtongji': 'Statistik rekening pihak ketiga',
};
