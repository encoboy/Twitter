export default {
  ...
  'menu.shujutonji': 'estatísticas de dados',
  'menu.shujutonji.zhanghaotongji': 'Estatísticas de contas próprias',
  'menu.shujutonji.sanfangtongji': 'Estatísticas de contas de terceiros',
};
