export default {
  ...
  'pages.searchTable.fenxizongliang': 'Total de ventoinhas',
  'pages.searchTable.fenxigaibian': 'Os fãs mudam',
  'pages.searchTable.zhangfenlv': 'Taxa de inchaço da farinha',
  'pages.searchTable.dianzanliang': 'Curtidas totais',
  'pages.searchTable.pinglunliang': 'Total de comentários',
  'pages.searchTable.zhuanfaliang': 'Encaminhamento Total',
  'pages.searchTable.list': 'lista',
  'pages.searchTable.ri': 'dia',
  'pages.searchTable.yue': 'mês',
  'pages.searchTable.nian': 'ano',
  'pages.searchTable.name': 'nome',
  'pages.searchTable.zanfenbi': 'Rácio pó da Zâmbia',
  'pages.searchTable.fensinum': 'Número de ventoinhas',
  'pages.searchTable.dianzannum': 'Número de curtidas',
  'pages.searchTable.pinglunnum': 'Número de comentários',
  'pages.searchTable.zhuanfanum': 'Quantidade de encaminhamento',
  'pages.searchTable.tuiwennum': 'Número de tweets',
  'pages.searchTable.del': 'apagar',
  'pages.searchTable.add': 'adicionar a',
  'pages.searchTable.shujutonji': 'estatísticas de dados',
  'pages.searchTable.zhanghaotongji': 'Estatísticas de contas próprias',
  'pages.searchTable.sanfangtongji': 'Estatísticas de contas de terceiros',
};
