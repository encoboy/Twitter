export default {
  ...
  'menu.shujutonji': 'তথ্য পৰিসংখ্যা',
  'menu.shujutonji.zhanghaotongji': 'স্বয়ংক্ৰিয় অ্যাকাউন্ট পৰিসংখ্যা',
  'menu.shujutonji.sanfangtongji': 'তৃতীয় পাৰ্টি একাওন্ট পৰিসংখ্যা',
};
