export default {
  ...
  'pages.searchTable.fenxizongliang': '粉絲總量',
  'pages.searchTable.fenxigaibian': '粉絲變化',
  'pages.searchTable.zhangfenlv': '漲粉率',
  'pages.searchTable.dianzanliang': '點讚總量',
  'pages.searchTable.pinglunliang': '評論總量',
  'pages.searchTable.zhuanfaliang': '轉發總量',
  'pages.searchTable.list': '列表',
  'pages.searchTable.ri': '日',
  'pages.searchTable.yue': '月',
  'pages.searchTable.nian': '年',
  'pages.searchTable.name': '名稱',
  'pages.searchTable.zanfenbi': '讚粉比',
  'pages.searchTable.fensinum': '粉絲數量',
  'pages.searchTable.dianzannum': '點讚數量',
  'pages.searchTable.pinglunnum': '評論數量',
  'pages.searchTable.zhuanfanum': '轉發數量',
  'pages.searchTable.tuiwennum': '推文數量',
  'pages.searchTable.del': '刪除',
  'pages.searchTable.add': '添加',
  'pages.searchTable.shujutonji': '數據統計',
  'pages.searchTable.zhanghaotongji': '自有帳號統計',
  'menu.shujutonji.sanfangtongji': '第三方賬號統計',
};
