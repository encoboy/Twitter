export default {
  ...
  'pages.searchTable.fenxizongliang': 'همۀ طرفداران',
  'pages.searchTable.fenxigaibian': 'تغییر طرفداران',
  'pages.searchTable.zhangfenlv': 'سرعت تخم گل',
  'pages.searchTable.dianzanliang': 'کاملاً دوست دارند',
  'pages.searchTable.pinglunliang': 'توضیح عمومی',
  'pages.searchTable.zhuanfaliang': 'همۀ پیش‌فرستادن',
  'pages.searchTable.list': 'فهرست',
  'pages.searchTable.ri': 'روز',
  'pages.searchTable.yue': 'ماه',
  'pages.searchTable.nian': 'سال',
  'pages.searchTable.name': 'نام',
  'pages.searchTable.zanfenbi': 'نسبت پودر زامبیا',
  'pages.searchTable.fensinum': 'تعداد طرفداران',
  'pages.searchTable.dianzannum': 'تعداد مانند',
  'pages.searchTable.pinglunnum': 'تعداد توضیح‌ها',
  'pages.searchTable.zhuanfanum': 'مقدار پیش‌فرستادن',
  'pages.searchTable.tuiwennum': 'تعداد tweets',
  'pages.searchTable.del': 'حذف',
  'pages.searchTable.add': 'افزودن به',
  'pages.searchTable.shujutonji': 'آمار داده',
  'pages.searchTable.zhanghaotongji': 'آمار حساب خودش',
  'pages.searchTable.sanfangtongji': 'آمار حساب سوم',
};
